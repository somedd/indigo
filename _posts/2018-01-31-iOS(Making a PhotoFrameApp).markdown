...
## Step1. 시작하기 (Tabbed App 템플릿)
  ...
  - 실행화면
  - ![screensh_step1](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step1.png)
...
## Step2. IBOutlet
  ...
  - 실행화면
  - ![screemsh_step2](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step2.png)
...
## Step3. IBAction
  ...
  - 실행화면
  - ![screemsh_step3](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step3.png)
...
## Step4. Scene과 Segue
  ...
  - 실행화면
  - ![screemsh_step4_1](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step4_1.png)
  - ![screemsh_step4_2](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step4_2.png)
  - ![screemsh_step4_3](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step4_3.png)
...
## Step5. ViewController 프로그래밍
  ...
  - 기존 실행화면
    - ![screemsh_step5](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step5.png)
  ...
  - YellowViewController에서 Segue를 제거하고 다음 화면을 보여줄 때 코드로 보여주는 방법을 찾아보고 적용해본다.
    ...
    ```
    - 위 방법을 반영한 실행화면
    - ![screemsh_step5_2](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step5_2.png)
...
## Step6. Container ViewController
  ...
  - 실행화면
  - ![screemsh_step6](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step6.png)
  - ![screemsh_step6_2](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step6_2.png)
...
## Step7. Second Scene 화면
  ...
  - 실행화면
  - ![screemsh_step7](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step7.png)
  ...
  - 이미지 뷰의 속성은 어떤 것들이 있는지 애플 개발자 문서를 참고한다.
    - 애플 개발자 문서
    - ![screemsh_step7_2](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step7_2.png)
      1. Image View: 이미지
        - Image : 표시할 이미지
...
## Step8. 추가 구현사항
  1. 이미지 테두리 액자 화면을 추가한다.
    - 실행화면
    - ![screemsh_step8](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step8.png)

  2. 사진 앨범에서 사진을 가져와서 보여줄 수 있도록 개선한다.
    - selectButtonTouched에서는 UIImagePickerController로 사진 앱 - 카메라롤에서 사진을 가져오도록 구현한다.
    - 실행화면
    - ![screemsh_step8_2](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step8_2.png)
    ![screemsh_step8_3](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step8_3.png)
    ![screemsh_step8_4](https://github.com/somedd/swift-photoframe/raw/somedd/img/Step8_4.png)
